...
#        if fundamental_checkbox:
 ...
 #           st.dataframe(ratio_indicators(ticker))
        ...
        if rs_checkbox: 
            ...
            ''' Comparamos a rolling sharpe ratio geométrica (RSR) das ações com a rolling sharpe ratio geométrica do S&P500 (TR).
            Calculamos a RSR corrigindo a taxa livre de risco igual a 0.
            Hence *RSR = média_de_retornos_móveis / desvio_padrão_de_retornos_móveis*.
            ''' 
